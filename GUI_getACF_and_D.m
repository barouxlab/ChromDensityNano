...
% Last Modified by GUIDE v2.5 13-Feb-2017 14:07:36
...
% --- Executes on button press in checkbox_DisplayFiguresACF.
function checkbox_DisplayFiguresACF_Callback(hObject, eventdata, handles)
% hObject    handle to checkbox_DisplayFiguresACF (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
display   = get(handles.checkbox_DisplayFiguresACF,'Value');
Rmin      = str2double(get(handles.editRmin_value_ACF,'String'));
saveName  = get(handles.edit_ACF_saveFileName,'String');
get_ACF (directory, prefix, SNR, Rmin,saveName, display);
...
function Dfile1_text_Callback(hObject, eventdata, handles)
% hObject    handle to Dfile1_text (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% --- Executes during object creation, after setting all properties.
function Dfile1_text_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Dfile1_text (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function Dfile2_text_Callback(hObject, eventdata, handles)
% hObject    handle to Dfile2_text (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes during object creation, after setting all properties.
function Dfile2_text_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Dfile2_text (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in pushbutton_Dfile1.
function pushbutton_Dfile1_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_Dfile1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[savedACF,directory,~] = uigetfile;
set(handles.Dfile1_text, 'String',[directory,savedACF])



% --- Executes on button press in pushbutton_Dfile2.
function pushbutton_Dfile2_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_Dfile2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[savedACF,directory,~] = uigetfile;
set(handles.Dfile2_text, 'String',[directory,savedACF])



% --- Executes on button press in pushbutton_compareD.
function pushbutton_compareD_Callback(hObject, eventdata, handles)
Dfile1  = get(handles.Dfile1_text, 'String');
Dfile2  = get(handles.Dfile2_text, 'String');
